"""
Django settings for lamouliesdor project.
...
SECRET_KEY = 'l+nb)m*qq=d5*7)7gbi0*q(eg&9oi7gl-i%_9d%qv-vh)mc_d3'
...
ROOT_URLCONF = 'lamouliesdor.urls'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = (os.path.join(BASE_DIR, 'polls/static/','/static'),)
